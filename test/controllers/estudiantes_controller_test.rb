...
class EstudiantesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create estudiante" do
    assert_difference('Estudiante.count') do
      post estudiantes_url, params: { estudiante: { carrera: @estudiante.carrera, f_nacimiento: @estudiante.f_nacimiento, id: @estudiante.id, name: @estudiante.name } }
    end
  ...
  test "should update estudiante" do
    patch estudiante_url(@estudiante), params: { estudiante: { carrera: @estudiante.carrera, f_nacimiento: @estudiante.f_nacimiento, id: @estudiante.id, name: @estudiante.name } }
